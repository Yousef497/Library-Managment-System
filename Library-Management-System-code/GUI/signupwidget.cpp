...
SignUp::SignUp(QWidget* parent): QWidget(parent)
{
    ...
    this->pixMap =new QPixmap(QCoreApplication::applicationDirPath()+"/../../Library-Management-System/icons/here.png");
    ...
    this->SignUpBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white;");
    ...
    this->Name->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");

    this->Email = new QLineEdit;
    this->Email->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");

    this->Password = new QLineEdit;
    this->Password->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");

    this->ConfirmPassword = new QLineEdit;
    this->ConfirmPassword->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
