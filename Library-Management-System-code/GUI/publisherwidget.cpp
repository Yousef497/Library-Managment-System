...
PublisherWidget::PublisherWidget(QWidget *parent) : QWidget(parent)
{
    ...
    this->addBookBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; width: 200px;"
                                    "hover{background-color:white; color:#696969;}"); // hover is not working
    this->addBookBtn->setCursor(Qt::PointingHandCursor);

//    this->BackBtn = new QPushButton("Logout");
//    this->BackBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; width: 100px;");
//    this->BackBtn->setCursor(Qt::PointingHandCursor);

    this->bookName = new QLineEdit;
    this->bookName->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
    this->bookPrice = new QLineEdit;
    this->bookPrice->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
    this->bookType = new QLineEdit;
    this->bookType->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
...
//    this->showInfo->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; width: 100px;");
...
void PublisherWidget::initHeader()
{
    ...
    this->toolBar->setStyleSheet("QToolButton:hover{padding: 10px; background-color:white; color:#696969;}"
    ...
    this->headerWidget->setStyleSheet("background-color:#696969");
