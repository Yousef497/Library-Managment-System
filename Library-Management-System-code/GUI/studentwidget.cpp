...
void StudentWidget::initProfileWidget()
{
    ...
    QLabel* name = new QLabel("Name:");             this->nameEdit = new QLineEdit(); nameEdit->setReadOnly(true);  this->nameEdit->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
    QLabel* password = new QLabel("Password:");     this->passEdit = new QLineEdit(); passEdit->setReadOnly(true);  this->passEdit->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
    QLabel* email = new QLabel("Email:");           this->emailEdit = new QLineEdit();emailEdit->setReadOnly(true); this->emailEdit->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
    QLabel* cashAmount = new QLabel("Cash Amount:");this->cashEdit = new QLineEdit(); cashEdit->setReadOnly(true);  this->cashEdit->setStyleSheet("QLineEdit{ background-color:white;border: 2px solid #696969;border-radius: 5px;}");
//    name->setStyleSheet("background: white; color:#696969;");
//    password->setStyleSheet("background: white; color:#696969;");
//    email->setStyleSheet("background: white; color:#696969;");
//    cashAmount->setStyleSheet("background: white; color:#696969;");
    ...
    this->EditBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
    this->EditBtn->setCursor(Qt::PointingHandCursor);

    this->OkBtn = new QPushButton("Ok");
    this->OkBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
...
void StudentWidget::initReturnWidget()
{
    ...
    QLabel* enterBook = new QLabel("Enter return book :"); enterBook->setStyleSheet("color:#696969");
    this->ReturnBook = new QLineEdit();
    this->ReturnBook->setStyleSheet("background: white;");

    this->BackBtn = new QPushButton("Back");
    this->BackBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
    this->BackBtn->setCursor(Qt::PointingHandCursor);

    this->OkkBtn = new QPushButton("Ok");
    this->OkkBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
...
void StudentWidget::initBorrowedWidget()
{
    ...
    this->Ok1Btn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
...
void StudentWidget::initSearchWidget()
{
    ...
    QLabel *lbl = new QLabel("You want to search by :"); lbl->setStyleSheet("color:#696969");

    this->NameBtn = new QPushButton("Name");
    this->NameBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
    this->NameBtn->setCursor(Qt::PointingHandCursor);

    this->TypeBtn = new QPushButton("Type");
    this->TypeBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
    this->TypeBtn->setCursor(Qt::PointingHandCursor);

    this->PriceBtn = new QPushButton("Price");
    this->PriceBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
    this->PriceBtn->setCursor(Qt::PointingHandCursor);

    this->PubBtn = new QPushButton("Publisher");
    this->PubBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
    this->PubBtn->setCursor(Qt::PointingHandCursor);

    this->DoneBtn = new QPushButton("Done");
    this->DoneBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
...
void StudentWidget::initHistoryWidget()
{
    ...
    this->OkBtnh->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; ");
