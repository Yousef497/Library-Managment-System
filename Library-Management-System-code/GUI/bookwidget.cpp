...
{
    this->setStyleSheet("background: white;color: #696969; font-size: 18px; font-weight: 400;");
    this->Path = QCoreApplication::applicationDirPath();
    this->grid = new QGridLayout();

    this->bookName = new QLabel(); bookName->setStyleSheet("color:#696969;font-weight: bold;font-size: 15px;");
    this->bookType = new QLabel(); bookType->setStyleSheet("color:#696969;font-weight: bold;font-size: 15px;");
    this->bookPrice = new QLabel(); bookPrice->setStyleSheet("color:#696969;font-weight: bold;font-size: 15px;");
    this->bookPublisher = new QLabel(); bookPublisher->setStyleSheet("color:#696969;font-weight: bold;font-size: 15px;");
    this->bookAvailability = new QLabel(); bookAvailability->setStyleSheet("color:#696969;font-weight: bold;font-size: 15px;");
    ...
    this->borrowBtn->setStyleSheet("background: #696969; border-radius: 10px; padding: 10px 0px; color: white; width: 200px;");
    ...
    this->ReturnWidget->setStyleSheet("background: white;color: #696969; font-size: 18px; font-weight: 400;");
    this->ReturnLayout = new QGridLayout();
    this->enterBook = new QLabel("Enter expected return date :"); enterBook->setStyleSheet("color:#696969;");
